              ...
              <div className="container">
                <div className="row justify-content-center">
                  <div className="col-md-7 py-5">
                    <form className="m-5" onSubmit={(e) => actions.handleLogin(e, navigate)}>
                      <div className="row mb-3">
                        <label htmlFor="inputEmail" className="col-sm-2 col-form-label pe-0">
                          Email
                        </label>
                      ...
                      <div className="row mb-3">
                        <label htmlFor="inputPassword" className="col-sm-2 col-form-label pe-0">
                          Contraseña
                        </label>
                        <div className="col-sm-10">
